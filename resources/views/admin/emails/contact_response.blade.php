...
<head>
    <meta charset="utf-8">
    <title>Response from The Carat Casa</title>
    <style>
        body { 
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="customer-info">
                ...
                <p>Thank you for reaching out to <strong>The Carat Casa</strong>. We truly appreciate your interest in our jewellery and your time to connect with us. Below is our response to your recent enquiry.</p>
            </div>
            ...
            <div style="text-align: center; margin-top: 35px;">
                ...
                <a href="mailto:service@withclarity.com" class="btn">Contact The Carat Casa</a>
            </div>
        </div>

        <div class="footer">
            <p>&copy; {{ date('Y') }} The Carat Casa. All Rights Reserved.</p>
            <p>This is an automated response — please do not reply directly to this email.</p>
            <p><a href="https://thecaratcasa.com" style="color: #14344A; text-decoration: none;">Visit our website</a></p>
        </div>
    </div>
</body>
</html>

...
class ProductController extends Controller
{
    ...
    {
        // Create sample data for Products sheet
        $productsSample = [
            [
        ...
        $variationsSample = [
            [
                ...
                'metal_color_name' => 'White Gold',
                'tax_rate_codes' => 'GST_GOLD,GST_DIAMOND',
                'is_best_selling' => 1,
            ...
            foreach ($productsHeaders as $header) {
                ...
                switch ($header) {
                    ...
                    case 'Is Build Product':
                        $value = $data['is_build_product'] ? 'Yes' : 'No';
                        break;
                    case 'Is Sale':
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->except(['is_sale', 'is_gift', 'is_featured']);

...
class OrderItemTax extends Model
{
    ...
    /* =======================
     | ENUM CONSTANTS (DB SAFE)
     ======================= */

    const COMPONENT_DIAMOND = 'diamond_tax';
    const COMPONENT_GOLD    = 'gold_tax';
    const COMPONENT_MAKING  = 'making_tax';
    ...
    public function getComponentNameAttribute()
    {
        return str_replace('_tax', '', ucfirst($this->component_type));
    }
    ...
    {
        return $this->belongsTo(DiamondMaster::class, 'diamond_id', 'diamondid');
    }
    ...
    public function getFormattedTaxableValue()
    {
        return '₹' . number_format($this->taxable_value, 2);
    }
    ...
    public function getComponentTypeLabelAttribute()
    {
        return match ($this->component_type) {
            'diamond_tax' => 'Diamond Tax',
            'gold_tax' => 'Gold Tax',
            'making_tax' => 'Making Charges Tax',
